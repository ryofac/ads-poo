...
public class App {
    ...
    App(Banco bank, Scanner scanner) {
        BANK = bank;
        in = scanner;
    }
    ...
    void getData() {
        show("\n=================== STATUS BANCO =====================");
        show("TOTAL de contas ativas:\t\t" + BANK.quantidadeContas());
    ...
    String generateAccountNum() {
        int numAccount = (BANK.quantidadeContas() % 9) + 1;
        int charCode = 65 + BANK.quantidadeContas() / 10;
